...
export default function AssignFacultyModal({ isOpen, setIsOpen, faculty, handleAssignment}) {
  const [selectedFaculty, setSelectedFaculty] = useState(faculty[0]);

  const handleFacultyChange = async (e) => {
    const selected_faculty = faculty.find((faculty) => faculty.faculty_id === e);
                                ...
                                {faculty.map((faculty, index) => (
                                    ...
                                    <div className="mt-4 flex gap-x-3 justify-end">
                                        ...
                                        <button
                                            ...
                                            onClick={() => { handleAssignment(selectedFaculty) }}
                                        >
                                            Confirm
                                        </button>
                                    </div>
