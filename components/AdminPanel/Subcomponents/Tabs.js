            ...
            <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-primary-black">
                ...
                <li className="mr-2 cursor-pointer" onClick={()=>setActive("Students")}>
                    <a href="#" className={`inline-flex p-4 border-b-2 border-transparent rounded-t-lg group ${active === "Students" ?"text-blue-800 border-b-2 border-blue-800" :""}`}>
                        <svg aria-hidden="true" className={`w-5 h-5 mr-2 ${active === "Students" ?"text-blue-800 " :""} `} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zm0 14a6 6 0 110-12 6 6 0 010 12z" clipRule="evenodd"></path><path fillRule="evenodd" d="M10 6a2 2 0 100 4 2 2 0 000-4zm0 1a1 1 0 110 2 1 1 0 010-2z" clipRule="evenodd"></path></svg>Students
                    </a>
                </li>
            </ul>
        </div>
