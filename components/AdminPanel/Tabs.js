...
export default function Tabs({ active, setActive , role}) {
    ...
    return (
        <div className="border-b border-primary-black border-opacity-20 font-poppins">
            <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-primary-black">
                <li className={`mr-2 cursor-pointer ${role === "Instructor" && "hidden"}`} onClick={() => setActive("Faculty")}>
                ...
                <li className={`mr-2 cursor-pointer ${role === "Instructor" && "hidden"}`} onClick={() => setActive("Courses")}>
                ...
                <li className={`mr-2 cursor-pointer ${role === "Instructor" && "hidden"}`} onClick={() => setActive("Assigned")} >
                ...
                <li className={`mr-2 cursor-pointer ${role === "Instructor" && "hidden"}`} onClick={() => setActive("Students")}>
                ...
                <li className={`mr-2 cursor-pointer ${role === "Instructor" && "hidden"}`} onClick={() => setActive("Ip_Binding")}>
                ...
                <li className="mr-2 cursor-pointer" onClick={() => setActive("DB_Questions")}>
                    <a href="#" className={`inline-flex p-4 border-b-2 border-transparent rounded-t-lg group ${active === "DB_Questions" ? "text-blue-800 border-b-2 border-blue-800" : ""}`}>
                        <FaEdit className='w-5 h-5 mr-2'/>
                        View Databank Questions
                    </a>
                </li>
